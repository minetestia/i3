...
i3.new_tab("test1", {
  ...
  fields = function(player, data, fields)
    if fields.test then SWITCH = true end
  end,
})
...
i3.new_tab("test2", {
  ...
  formspec = function(player, data, fs) fs "label[3,1;Test 2]" end,
})
...
i3.new_tab("test_creative", {
  ...
  formspec = function(player, data, fs) fs "label[3,1;Creative enabled]" end,
