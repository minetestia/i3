...
local function lf(path) return assert(_loadfile(modpath .. path)) end
...
i3 = {
  ...
  settings = {
    ...
    progressive_mode = minetest.settings:get_bool "i3_progressive_mode",
  },
...
if i3.settings.progressive_mode then i3.files.progressive() end
